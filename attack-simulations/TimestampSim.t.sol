...
import {LowestPriceStrategy} from "../../contracts/strategies/LowestPriceStrategy.sol";
...
contract TimestampSim is Test {
    ...
    function setUp() public {
        ...
        address tenderAddr = factory.createTender(address(0), address(priceStrategy), "QmConfig", biddingTime, 1 days, 1 days, 1 ether);
    ...
    function testExactDeadlineBoundary() public {
        uint256 deadline = tender.biddingDeadline();
        ...
        bytes32 structHash = keccak256(abi.encode(BID_TYPEHASH, 1 ether, salt, meta));
