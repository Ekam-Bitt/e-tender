...
contract WeightedScoreStrategy is IEvaluationStrategy {
    ...
    constructor(
        uint256 _priceWeight,
        uint256 _deliveryWeight,
    ...
    function scoreBid(
        ...
        (uint256 deliveryTime, uint256 complianceScore) = abi.decode(
            metadata,
            (uint256, uint256)
        );
        ...
        uint256 compliancePenalty = (MAX_COMPLIANCE - complianceScore) *
            COMPLIANCE_WEIGHT;
