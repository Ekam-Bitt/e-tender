...
### Configuration
#### [NEW] [foundry.toml](../foundry.toml)
- Standard Foundry configuration.
- Solc version: 0.8.20+ (Paris support).

### Smart Contracts
#### [NEW] [contracts/Tender.sol](../contracts/Tender.sol)
...
#### [NEW] [contracts/TenderFactory.sol](../contracts/TenderFactory.sol)
- Deploys new `Tender` contracts.
- Emits `TenderCreated` event.

### Tests
#### [NEW] [test/Tender.t.sol](../test/Tender.t.sol)
