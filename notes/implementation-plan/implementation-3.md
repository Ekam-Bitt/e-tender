...
### Interfaces
#### [NEW] [contracts/interfaces/IIdentityVerifier.sol](../contracts/interfaces/IIdentityVerifier.sol)
- `verify(address user, bytes calldata proof) returns (bool)`

### Smart Contracts
#### [NEW] [contracts/identity/SignatureVerifier.sol](../contracts/identity/SignatureVerifier.sol)
...
#### [NEW] [contracts/identity/ZKMerkleVerifier.sol](../contracts/identity/ZKMerkleVerifier.sol)
- Implements `IIdentityVerifier`.
- Mocks a ZK-SNARK verifier.
- Verifies that `user` is part of a Merkle Tree Root (privacy-preserving set membership).

#### [MODIFY] [contracts/Tender.sol](../contracts/Tender.sol)
