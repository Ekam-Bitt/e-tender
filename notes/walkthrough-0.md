...
## Deliverables
1. **[Threat Model](file:///Users/ekambitt/Projects/e-tendering/threat-model/threat-model.md)**: Defined the security landscape.
...
2. **[State Machine](file:///Users/ekambitt/Projects/e-tendering/specs/state-machine.md)**: Defined the rigid lifecycle.
   - `CREATED`: Setup.
...
3. **[Trust Assumptions](file:///Users/ekambitt/Projects/e-tendering/specs/assumptions_trust.md)**:
