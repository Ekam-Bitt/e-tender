...
## Deliverables
1. **[IEvaluationStrategy.sol](../contracts/interfaces/IEvaluationStrategy.sol)**: Interface for pluggable scoring logic.
2. **[LowestPriceStrategy.sol](../contracts/strategies/LowestPriceStrategy.sol)**: Standard logic (Lowest Price wins).
3. **[WeightedScoreStrategy.sol](../contracts/strategies/WeightedScoreStrategy.sol)**: Complex logic (Price + Delivery + Compliance weights).
4. **[Tender.sol](../contracts/Tender.sol)**: Refactored to delegate scoring to the Strategy.
