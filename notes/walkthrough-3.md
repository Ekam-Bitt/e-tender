...
## Deliverables
1. **[IIdentityVerifier.sol](../src/interfaces/IIdentityVerifier.sol)**: The interface ensuring flexibility.
2. **[SignatureVerifier.sol](../src/identity/SignatureVerifier.sol)**: A basic "Issuer-based" VC implementation.
3. **[ZKMerkleVerifier.sol](../src/identity/ZKMerkleVerifier.sol)**: A skeleton for privacy-preserving proofs.
4. **[Tender.sol](../src/Tender.sol)**: Updated to perform `verifier.verify()` on bid submission.
