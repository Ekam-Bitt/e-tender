...
contract WeightedScoreStrategy is IEvaluationStrategy {
    uint256 public immutable priceWeight;
    uint256 public immutable deliveryWeight;
    uint256 public immutable complianceWeight;
    ...
    constructor(uint256 _priceWeight, uint256 _deliveryWeight, uint256 _complianceWeight) {
        ...
        deliveryWeight = _deliveryWeight;
    ...
    function scoreBid(uint256 amount, bytes calldata metadata) external view override returns (uint256) {
        ...
        uint256 pricePenalty = amount * priceWeight;
        uint256 deliveryPenalty = deliveryTime * deliveryWeight;
        uint256 compliancePenalty = (MAX_COMPLIANCE - complianceScore) * complianceWeight;
